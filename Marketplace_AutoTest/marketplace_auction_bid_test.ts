...
const getBuyerCredentials = () => {
  return {
    email: process.env.MARKETPLACE_BUYER_EMAIL || process.env.MARKETPLACE_EMAIL || 'acamet117@gmail.com',
    password: process.env.MARKETPLACE_BUYER_PASSWORD || process.env.MARKETPLACE_PASSWORD || '123456'
  };
};

const getBuyer2Credentials = () => {
  return {
    email: process.env.MARKETPLACE_BUYER2_EMAIL,
    password: process.env.MARKETPLACE_BUYER2_PASSWORD
  };
};

const getSellerCredentials = () => {
  return {
    email: process.env.MARKETPLACE_SELLER_EMAIL || process.env.MARKETPLACE_EMAIL || 'acamet117@gmail.com',
    password: process.env.MARKETPLACE_SELLER_PASSWORD || process.env.MARKETPLACE_PASSWORD || '123456'
  };
};
