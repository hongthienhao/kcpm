...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("🚨 CATCH BLOCK HIT! err:", err);
      setError(err.message || err.toString() || 'Email hoặc mật khẩu không đúng.');
      console.log("🚨 Set error to:", err.message || err.toString() || 'Email hoặc mật khẩu không đúng.');
      setTimeout(() => setError(''), 5000);
    } finally {
      setLoading(false);
    }
