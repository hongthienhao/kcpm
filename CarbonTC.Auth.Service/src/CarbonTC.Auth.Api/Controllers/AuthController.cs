...
using CarbonTC.Auth.Application.Features.Auth.Commands.ForgotPassword;
using CarbonTC.Auth.Application.Features.Auth.Commands.ResetPassword;
...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> ForgotPassword([FromBody] ForgotPasswordCommand command)
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(500, ApiResponse<object>.ErrorResult(
                "Đã xảy ra lỗi trong quá trình xử lý quên mật khẩu",
                ex.Message
            ));
        }
    }
